...
public class HttpUtilTest {
	...
	public void testGet() throws UnsupportedEncodingException {
		byte[] result = HttpUtil.send(null, "http://localhost:8080/grain-httpserver-test", null, HttpUtil.GET);
	...
	public void testPost() throws UnsupportedEncodingException {
		...
		byte[] result = HttpUtil.send(str, "http://localhost:8080/grain-httpserver-test/s", null, HttpUtil.POST);
	...
	public void testSendFile() throws UnsupportedEncodingException {
		...
		byte[] result = HttpUtil.sendFile(file, "http://localhost:8080/grain-httpserver-test/s", headMap, HttpUtil.POST);
		String returnStr = new String(result, "UTF-8");
		System.out.println(returnStr);
		assertEquals(true, str != null);
